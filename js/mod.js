let modInfo = {
	...
	modFiles: ["layers/layer1/layers.js", "tree.js", "layers/layer1/quarks.js", "layers/layer2/hypermultiplier.js", "layers/sidelayer/craftingtable.js",
		"layers/sidelayer/acheivments.js", "layers/layer2/vinylmultiplier.js", "layers/layer2/atoms.js", "layers/layer2/cosmicdust.js","layers/sidelayer/alchemylab.js","layers/layer3/cells.js","layers/layer3/heavymultiplier.js",
		"layers/layer3/tetra.js", "layers/layer3/boracite.js", "layers/layer4/dimensions.js", "layers/layer3/mechanicalmultiplier.js", "layers/sidelayer/artifacts.js", "layers/layer4/megamultiplier.js", "layers/layer4/organs.js",
		"layers/layer4/nissionite.js", "layers/layer5/evolution.js", "layers/layer6/omnimultiplier.js", "layers/layer5/nuclearmultiplier.js", "layers/layer5/axioms.js", "layers/layer6/volts.js", "layers/layer5/stargazedmetal.js",
		"layers/layer6/civilization.js", "layers/layer7/computers.js", "layers/layer7/entropy.js", "layers/layer7/pendulums.js", "layers/layer7/supermultiplier.js",
	],
...
function getPointGen() {
	...
	if(player.b.Panenite.gte(1)) gain = gain.times(player.b.paneniteMultiplier())   
	...
	if(getBuyableAmount('ce', 104).gte(1)) gain = gain.times(buyableEffect("ce", 104))
	if(hasUpgrade('m', 24)) gain = gain.times(1.1)
	if(getBuyableAmount('mm', 11).gte(1)) gain = gain.times(buyableEffect('mm', 11))
	if(player.ce.points.gte(1)) gain = gain.times(new Decimal(4).mul(player.ce.points))
	...
	if(getBuyableAmount('ce', 18).gte(1)) gain = gain.times(buyableEffect('ce', 18))
	if(getBuyableAmount('ce', 17).gte(1)) gain = gain.times(buyableEffect('ce', 17))
	...
	if(getBuyableAmount('t', 15).gte(1)) gain = gain.times(buyableEffect('t', 15))
	if(getBuyableAmount('t', 35).gte(1)) gain = gain.times(buyableEffect('t', 35))
	if(getBuyableAmount('t', 44).gte(1)) gain = gain.times(buyableEffect('t', 44))
	if(getBuyableAmount('t', 42).gte(1)) gain = gain.times(buyableEffect('t', 42))
	if(getBuyableAmount('t', 51).gte(1)) gain = gain.times(buyableEffect('t', 51))

	let formula1 = buyableEffect('t', 53)[0]
	let formula2 = buyableEffect('t', 53)[1]
	let formula3 = buyableEffect('t', 53)[2]

	if(getBuyableAmount('t', 53).gte(1)) gain = gain.times(formula1).times(formula2).times(formula3)
	if(getBuyableAmount('ct', 16).gte(1)) gain = gain.times(buyableEffect('ct', 16))
	if(inChallenge('t', 21)) {
         gain = gain.times(1)
	} else {
		...
		if(hasMilestone('h', 11)) gain = gain.times(player.h.points.plus(1).pow(0.5))
