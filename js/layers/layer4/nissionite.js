addLayer("n", {
    ...
    lore: {
        title: "Nissionite",
        body() { return `Nissionite is another rare Earth mineral, its chemical composition is too complex to fit here. You may be wondering, 
    ...
    hotkeys: [
        {key: "N", description: "N: Reset for Nissionite", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
    ],
   ...
   if(player.n.unlocked || tmp.n.canReset) {
    ...
    bigBar: {
        ...
        width: 600,
        height: 50,
        textStyle: { "font-size": "20px", "font-family": "Arial", "text-align": "center", "color": "black" },
        borderStyle: { "border": "4px solid black", "border-radius": "0px" },
        display() { return "Time remaining until blizzard: " + format(player.n.timer) + " ticks" },
        progress() { return player.n.timer / 3000},
    ...
    11: {
        ...
        challengeDescription() {
            return "Enact a super-hard softcap on Cosmic Dust, every nissionite you have reduces the harshness of this softcap. Every completion increases the harshness, and requirement. Current Completions: " + format(challengeCompletions("n", 11))
        },
        goalDescription() {
            if(challengeCompletions("n", 11) >= 6) return "Get 999 Boracite"
            return "Get " + format(50 + ((challengeCompletions("n", 11)) * 50)) + " Boracite"
        },
        rewardDescription: "Gain new Boracite milestones, a cosmic dust and vinyl boost, and new Nissionite-fragment upgrades",
        rewardEffect() {
        ...
        rewardDisplay() {
            return "Effect: " + format(this.rewardEffect()) + "x boost Cosmic Dust and Vinyl. New Boracite milestone and Nissionite upgrade each completion."
        },
        completionLimit: 7,
        style: {"width": "375px", "height": "375px", "font-size": "16px", "border-radius": "0px",},
        canComplete() {
        ...
        unlocked() {return player.n.points.gte(3)},
        onEnter() {
  ...
  upgrades: {
    11: {
        ...
        description: "Multiplier and Quarks are no longer reset, by anything. Forevermore.",
        cost: new Decimal(40),
    ...
    12: {
        ...
        currencyInternalName: "fragments",
        currencyLayer: "n",
        style: {"width": "200px", "height": "200px", "font-size": "12px", "animation": "backgroundMove 1s linear infinite", "border-radius": "100px",},
      
        
    }, 
    13: {
        title: "Chilled Iceberg",
        description: "2x Tetra gain, 10x Quark gain, 10x Multiplier gain, and unlock Frost Arzendics",
        cost: new Decimal(3000),
        currencyDisplayName: "Fragments",
        currencyInternalName: "fragments",
        currencyLayer: "n",
        style: {"width": "200px", "height": "200px", "font-size": "12px", "animation": "backgroundMove 0.8s linear infinite","border-radius": "100px",},
    ...
    14: {
        ...
        currencyInternalName: "fragments",
        currencyLayer: "n",
        unlocked() {return challengeCompletions("n", 11) >= 1},
        style: {"width": "200px", "height": "200px", "font-size": "12px", "animation": "backgroundMove 0.8s linear infinite","border-radius": "100px",},
    ...
    21: {
        ...
        currencyInternalName: "fragments",
        currencyLayer: "n",
        unlocked() {return challengeCompletions("n", 11) >= 2},
        style: {"width": "200px", "height": "200px", "font-size": "12px", "animation": "backgroundMove 0.8s linear infinite","border-radius": "100px",},
    ...
    23: {
        ...
        currencyInternalName: "fragments",
        currencyLayer: "n",
        unlocked() {return challengeCompletions("n", 11) >= 4},
        style: {"width": "200px", "height": "200px", "font-size": "12px", "animation": "backgroundMove 0.8s linear infinite","border-radius": "100px",},
    ...
    24: {
        ...
        currencyInternalName: "fragments",
        currencyLayer: "n",
        unlocked() {return challengeCompletions("n", 11) >= 5},
        style: {"width": "200px", "height": "200px", "font-size": "12px", "animation": "backgroundMove 0.8s linear infinite","border-radius": "100px",},
    ...
    31: {
        ...
        currencyInternalName: "fragments",
        currencyLayer: "n",
        unlocked() {return challengeCompletions("n", 11) >= 6},
        style: {"width": "200px", "height": "200px", "font-size": "12px", "animation": "backgroundMove 0.8s linear infinite","border-radius": "100px",},
    ...
    32: {
        ...
        currencyInternalName: "fragments",
        currencyLayer: "n",
        unlocked() {return challengeCompletions("n", 11) >= 7},
        style: {"width": "200px", "height": "200px", "font-size": "12px", "animation": "backgroundMove 0.8s linear infinite","border-radius": "100px",},
    ...
    "The Icy Palace": {
        ...
        content: [
           ...
           ["prestige-button", function() {return "prestige-button"}
            ...
            ["display-text", function() {return 'You have ' + format(player.b.points) + ' Boracite.'}],
            ["display-text", function() {return 'You have ' + format(player.n.fragments) + ' Fragments.'}],
            "blank",
            ["infobox", "lore"],
            ["bar", "bigBar"],
            ["display-text", function() {return 'Snowstorm lasting for ' + (player.n.random > 0 ? format(player.n.random) : "N/A") + ' ticks.'}],
           "upgrades",
           "challenges",
        ],
