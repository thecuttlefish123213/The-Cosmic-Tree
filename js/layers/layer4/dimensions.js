    ...
    socrates: {
        title: "Socrates",
        body() { return `An ancient greek philosopher, responsible for inspiring many of the great thinkers. Not much is known about Socrates
    ...
    time: {
        title: "4th Dimension",
        body() { return `Time is our 4th dimension, the one we cannot escape. So far, not much can be said about time, because our understanding is very limited, however, 
    ...
    newton: {
        ...
        body() { return `Yes, an apple does fall. Issac Newton is the renound scientist for discovering gravity, by witnessing an apple fall from the tree in his home in London
    ...
    aristotle: {
        title: "Aristotle",
        body() { return `Aristotle, the mentor of Alexander the Great, supposed Earth was at the center of the Universe, and so followed a firmly held beleif in a geocentric universe,
    ...
    euclid: {
        title: "Euclid",
        body() { return `The Father of Geometry from Ancient Greece, who established many theorems that dominated the field until the 19th century. Not much is known
    ...
    darwin: {
        ...
        body() { return `He traveled to the Galapagos Islands in order to study unique species. Darwin noticed the slight variations in animals across the islands and 
    ...
    einstein: {
        ...
        body() { return `A genius in theoretical physics, now renound for his energy equation 'E = mc^2' Energy equals mass times the speed of light squared. Einstein was born
    ...
    opp: {
        ...
        body() { return `Oppenheimer is another genius in theoretical physics, born in NYC but earned his degree in chemistry from Harvard. In 1942, Oppenheimer
    ...
    sTheory: {
        title: "String Theory",
        body() { return `String Theory is a very difficult to explain theory, but in an nutshell, it unifies ALL of physics, which is a nigh-impossible task. It seeks to combine General Relativity,
   ...
   update() {
    ...
    gainMult() { // Calculate the multiplier for main currency from bonuses
        mult = new Decimal(1)
         ...
         mult = mult.times(upgradeEffect('d', 21))
        if(getBuyableAmount('d',12).gte(1)) mult = mult.times(buyableEffect('d', 12))
        if(getBuyableAmount('ct', 21).gte(1)) mult = mult.times(buyableEffect('ct', 21))
        if(player.chm.mechanicalBomb.gte(1)) mult = mult.times(buyableEffect('chm', 24)[0])
        if(hasUpgrade('d', 36)) mult = mult.times(2)
        if(player.ce.mJannaschii.gte(1)) mult = mult.times(buyableEffect('ce', 44))
    ...
    "Requiem for Verses": {
        content: [
           ...
           "blank",
            ...
            function() { return hasUpgrade('d', 22) ? ["display-text",  '<br>You have ' + format(player.d.basalt) + ' Basalt ',
             {"font-size": "40px", "display": "inline-block", "color": "#beb6b6", "border": "2px ridge #989898","background-size": "cover","background-position": "center",
                "background-origin": "border-box","background-repeat": "no-repeat", "width": "600px", "height": "120px",
                "background": "radial-gradient(circle at 50% 40%, rgb(65, 63, 73) 0%, rgb(61, 60, 68) 40%, rgb(8, 7, 61) 100%)", 
           ...
           ["blank", "30px"],
           function() { return hasChallenge('d', 11) ? ["display-text", "The Second Dimension",
            {"font-size": "30px"}
           ] : null },
           function() { return hasChallenge('d', 11) ? ["row", [["upgrade", "15"],["raw-html",`<div><button id="black" onclick="blackSquare()" type="button" style='width: 100px; height: 100px; border: 2px solid white; box-sizing: border-box; background-color: black; position: relative'></button></div>`],
             ["upgrade", "16"], ["upgrade", "17"], ["upgrade", "18"], 
           ]]
             : null },
             function() {return hasChallenge('d', 11) ? ["challenge", "12"] : null},
              function() { return hasChallenge('d', 12) ? ["display-text", "The Third Dimension", {"font-size": "30px"}] : null },
              function() { return hasChallenge('d', 12) ? ["row", [["upgrade", "19"], ["upgrade", "20"], ["upgrade", "21"], ["upgrade", "22"], ["upgrade", "23"], ["upgrade", "24"], ["challenge", "13"], 
             hasChallenge('d', 12) ? ["raw-html", `<div class='horizontalBox' style='width: 700px; height: 600px; border: 2px solid white; box-sizing: border-box;'><br>
    ...
    "Dawn of the Primates": {
        content: [
        function() { return hasChallenge('d', 13) ? ["display-text", "The Fourth Dimension | Villa of Philosophy", {"font-size": "30px"}] : null },
        function() { return hasChallenge('d', 13) ? ["infobox", "socrates"] : null },
        function() { return hasChallenge('d', 13) ? ["infobox", "time"] : null },
        function() { return hasChallenge('d', 13) ? ["row", [["upgrade", "25"], ["upgrade", "26"], ["upgrade", "27"], ["upgrade", "28"], ["upgrade", "29"]]] : null},
        function() {return hasChallenge('d', 13) ? ["row", [["buyable", "12"], ["challenge", "14"], ["buyable", "13"]]] : null},
        function() { return hasChallenge('d', 14) ? ["display-text", "The Fifth Dimension | Cradle of Gravity", {"font-size": "30px"}] : null },
        function() { return hasChallenge('d', 13) ? ["infobox", "newton"] : null },
        function() { return hasChallenge('d', 14) ? ["row", [["buyable", "14"], ["buyable", "15"], ["buyable", "16"], ["buyable", "17"], ["buyable", "18"], ["buyable", "19"], ["upgrade", "30"], ]] : null},
        function() { return hasUpgrade('d', 30) ? ["display-text", "The Sixth Dimension | Geocentrism", {"font-size": "30px"}] : null },
        function() { return hasUpgrade('d', 30) ? ["infobox", "aristotle"] : null },
        function() { return hasUpgrade('d', 30) ? ["row", [["challenge","15"]]] : null},
        function() { return hasUpgrade('d', 30) ? ["raw-html", `<div class='horizontalBox' style='width: 700px; height: 600px; border: 2px solid white; box-sizing: border-box;'>
    ...
    "Father of Geometry": {
        content: [
            function() { return hasChallenge('d', 15) ? ["display-text", "The Seventh Dimension | Euclidian Embark", {"font-size": "30px"}] : null },
            function() { return hasChallenge('d', 15) ? ["infobox", "euclid"] : null },
            function() { return hasChallenge('d', 15) ? ["row", [["upgrade","31"],["upgrade","32"],["upgrade","33"],["upgrade","34"],["upgrade","35"]]] : null},
            function() { return hasChallenge('d', 15) ? ["row", [["challenge","16"]]] : null},
            function() { return hasChallenge('d', 16) ? ["display-text", "The Eighth Dimension | Eden of Evolution", {"font-size": "30px"}] : null },
            function() { return hasChallenge('d', 16) ? ["infobox", "darwin"] : null },
            function() { return hasChallenge('d', 16) ? ["row", [["upgrade","36"],["upgrade","37"],["upgrade","38"],["upgrade","39"],["buyable", "20"]]] : null},
            function() { return hasChallenge('d', 16) ? ["row", [["challenge","17"]]] : null},
            function() { return hasChallenge('d', 17) ? ["display-text", "The Nineth Dimension | The Manhattan Project", {"font-size": "30px"}] : null },
            function() { return hasChallenge('d', 17) ? ["infobox", "einstein"] : null },
            function() { return hasChallenge('d', 17) ? ["infobox", "opp"] : null },
            function() { return hasChallenge('d', 17) ? ["row", [["challenge","18"]]] : null},
            function() {return inChallenge('d', 18) ? ["raw-html", `<div class='horizontalBox' style='width: 700px; height: 600px; border: 2px solid white; box-sizing: border-box;'>
                <br><br><br><br><br><button  id="Earth" onclick='end()' style="border-radius: 1000px; width: 350px; height: 350px; background-color: green; ">Don't do it... don't click!</button></div>`] : null}
        
        ]
    },
    "String Theory": {
        content: [
            function() { return hasChallenge('d', 18) ? ["display-text", "The Tenth Dimension | Awakenings of Creation", {"font-size": "30px"}] : null },
            function() { return hasChallenge('d', 18) ? ["infobox", "sTheory"] : null },
             function() { return hasChallenge('d', 18) ? ["row", [["upgrade","40"],["upgrade","41"],["upgrade","42"],["upgrade","43"],
            ["upgrade","44"],["upgrade","45"],["upgrade","46"],["upgrade","47"],["upgrade","48"],["upgrade","49"],["upgrade","50"]]] : null},
            function() { return hasChallenge('d', 18) ? ["row", [["challenge","19"]]] : null},
            function() { return hasChallenge('d', 19) ? ["display-text", "The Eleventh Dimension | The Quest For Life", {"font-size": "30px"}] : null },
            function() { return hasChallenge('d', 19) ? ["row", [["upgrade","51"]]] : null},
        ]
    },
    },
    upgrades: {
    ...
    19: {
        ...
        description: "Clicking a snowflake has a minor chance to give 50 polymetrics, may increase later.",
        cost: new Decimal(20),
        style: {
            "width": "200px",
            "height": "200px",
    ...
    29: {
        ...
        description: "+150 Basalt, unlock bastion craftable, improve length buyable",
    ...
    30: {
        title: "Angry Earth",
        description: "+1000 Basalt, +1000 polymetrics, +1000 tetra Boost, Unlock the 6th dimension, Geocentrism",
    ...
    34: {
        ...
        description: "Very not good... +1000 Tetra boost, +10K polymetrics, +10 Bastion.",
        cost: new Decimal(10),
    ...
    35: {
        title: "The Great War",
        description: "A battle across the Cosmos... + 15 Units of Fire, 1.5x Nissionite and MM boost ",
    ...
    39: {
        ...
        description: "1e12 Cosmic Dust boost, unlock a new prokaryote, raise DNA and RNA cap to be based on total Nucleii",
    ...
    11: {
        ...
        title: "Length",
        display() { return "Receive " + format(this.effect(getBuyableAmount(this.layer, this.id))) + " Polymetrics on reset. "  + "cost: " + format(this.cost()) + " polymetrics"},
     ...
     12: {
        cost(x) { return new Decimal(25).mul(x.plus(1)) },
        title: "Corrupted Youth",
        display() { return "Fire now boosts dimensional points | cost: " + format(this.cost()) + " basalt | Currently: " + format(buyableEffect('d', 12)) + "x boost"},
        canAfford() { return player[this.layer].basalt.gte(this.cost()) },
        effect(x) { return new Decimal(1).add(player.ct.fire.times(0.1)) },
    ...
    13: {
        cost(x) { return new Decimal(75).mul(x.plus(1)) },
        title: "Denounced Gods",
        display() { return "Boost Tetra with +levels using basalt | cost: " + format(this.cost()) + " basalt | Currently: " + format(buyableEffect('d', 13)) + "x boost"},
        canAfford() { return player[this.layer].basalt.gte(this.cost()) },
        effect(x) { return new Decimal(1).add(player.ct.fire.times(0.5)) },
    ...
    14: {
        cost(x) { return new Decimal(50).mul(x.plus(1)) },
        title: "Forest of Virtue",
        display() { return "Boost Mega Multiplier! | cost: " + format(this.cost()) + " dimensional points | Currently: " + format(buyableEffect('d', 14)) + "x boost"},
        canAfford() { return player[this.layer].points.gte(this.cost()) },
        effect(x) { return new Decimal(1).add(x.mul(0.7)) },
    ...
    15: {
        cost(x) { return new Decimal(300).mul(x.plus(1)) },
        title: "High-English Mathematics",
        display() { return "Boost Cells! | cost: " + format(this.cost()) + " polymetrics | Currently: " + format(buyableEffect('d', 15)) + "x boost"},
        canAfford() { return player[this.layer].polymetrics.gte(this.cost()) },
        effect(x) { return new Decimal(1).add(x.mul(0.7)) },
    ...
    16: {
        cost(x) { return new Decimal(222) },
        title: "Calculus Battle",
        display() { return "Convert Polymetrics to Basalt! | cost: " + format(this.cost()) + " polymetrics"},
        canAfford() { return player[this.layer].polymetrics.gte(this.cost()) },
    ...
    17: {
        cost(x) { return new Decimal(20.5).mul(x.plus(1)) },
        title: "Integrating Pies",
        display() { return "Boost Nissionite! | cost: " + format(this.cost()) + " basalt" + " | currently: " + format(this.effect()) + "x"},
        canAfford() { return player[this.layer].basalt.gte(this.cost()) },
        effect(x) { return new Decimal(1).add(x.mul(0.5)) },
    ...
    18: {
        cost(x) { return new Decimal(66.6).mul(x.plus(1)) },
        title: "Differential Apples",
        display() { return "Boost Particles! | cost: " + format(this.cost()) + " Dimensional Points" + " | currently: " + format(this.effect()) + "x"},
        canAfford() { return player[this.layer].points.gte(this.cost()) },
        effect(x) { return new Decimal(1.75).pow(x) },
    ...
    19: {
        cost(x) { return new Decimal(666).mul(x.plus(1)) },
        title: "THE DEMON'S TAIL",
        display() { return "Boost Tetra! | cost: " + format(this.cost()) + " Polymetrics" + " | currently: " + format(this.effect()) + "x"},
        canAfford() { return player[this.layer].points.gte(this.cost()) },
        effect(x) { return new Decimal(6.66).mul(x) },
    ...
    20: {
        cost(x) { return new Decimal(1500).mul(x.plus(1).plus(2)).mul(x.mul(0.05).plus(1)) },
        title: "Icy Emboldening",
        display() { return "Get more polymetrics when clicking snowflakes | cost: " + format(this.cost()) + " Polymetrics" + " | currently: " + "50+" + format(this.effect()) },
        canAfford() { return player[this.layer].polymetrics.gte(this.cost()) },
        effect(x) { return new Decimal(1000).mul(x) },
    ...
    12: {
        ...
        canComplete: function() {return player.ce.points.gte(100)},
        style: {
            "border-radius": "0px",
            "font-size": "20px"
        }
    ...
    13: {
        ...
        goalDescription: "You need audio to do the minigame, if you do not have audio, go to the guide book for the solution of which squares to click",
        canComplete: function() {return player.d.squareGameCompleted},
        style: {
            "border-radius": "0px",
            "font-size": "19px"
        }
    ...
    14: {
        ...
        canComplete: function() {return player.hm.points.gte(10000)},
        style: {
            "border-radius": "0px",
            "font-size": "19px"
        }
    ...
    15: {
        ...
        rewardDescription: "Unlock the 7th Dimension, Euclidian Embark(Father of Geometry)",
        goalDescription: "Click down below to begin",
        canComplete: function() {return player.d.cosmicQuizCompleted},
        style: {
            "border-radius": "0px",
            "font-size": "19px"
        }
    ...
    16: {
        ...
        canComplete: function() {return player.chm.hDrone.gte(1)},
        style: {
            "border-radius": "0px",
            "font-size": "19px"
        }
    ...
    17: {
        ...
        goalDescription: "Obtain one of each prokaryote currently available(so 4)",
        canComplete: function() {return player.ce.mSmithii.gte(1) && player.ce.sSolfataricus.gte(1) && player.ce.halobacterium.gte(1) && player.ce.mJannaschii.gte(1)},
        style: {
            "border-radius": "0px",
            "font-size": "19px"
        }
    ...
    18: {
        ...
        challengeDescription: "Craft a nuke, and nuke the Earth! This is a craftable(You must enter the Challenge to complete this one, after making a nuke)",
        rewardDescription: "Unlock the 10th Dimension(String Theory) Awakenings of Creation.",
        goalDescription: "NUKE THE EARTH",
        canComplete: function() {return player.d.earthNuked},
        onEnter() {
            destruction()
        },
        onExit() {
    ...
    19: {
        ...
        canComplete: function() {return player.d.challengeCompletedFunction()},
        onEnter() {
            destruction()
        },
        onExit() {
