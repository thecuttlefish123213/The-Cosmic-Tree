    ...
    requires() {
         return new Decimal(1000)}, // Can be a function that takes requirement increases into account
    ...
    "Tetratum": {
        content: [
           ...
           ["prestige-button", function() {return "prestige-button"}
            ...
            ["display-text", function() {return 'You have ' + format(player.v.points) + ' vinyl multiplier.'}],
            "blank",
             ["display-text", function() {return 'Tetras tend to create structures across dimensions. Use your tetras to make tetra points to buy structures! Note, each COLUMN(including Empryean buyables) has a maximum limit of 5, some buyables only have 1 despite this. So, Tetrated Stars, Planets, Galaxies, Blackholes and Universes have a collective limit of 5. Buy wisely!'},
                {"fontSize": "20px"}
             ],
              "blank",
                ["display-text", function() {return 'You have ' + format(player.t.tpoints) + ' 2D tetra points.'},
                    {"fontSize": "25px"}
                ],
                 "blank",
                ["display-text", function() {return 'You have ' + format(player.t.points3) + ' 3D tetra points.'},
                    {"fontSize": "25px"}
                ],
                 "blank",
                ["display-text", function() {return 'You have ' + format(player.t.points4) + ' 4D tetra points.'},
                    {"fontSize": "25px"}
                ],
                 "blank",
                ["display-text", function() {return 'You have ' + format(player.t.points5) + ' Imperial points.'},
                    {"fontSize": "25px"}
                ],
                 "blank",
                ["display-text", function() {return 'You have ' + format(player.t.points6) + ' Empryean points.'},
                    {"fontSize": "25px"}
                ],
              ["column",[["row",[["buyable", "91"],"blank",["buyable", "92"],"blank",["buyable", "93"]]]]],
            ["column",[["row",[["buyable", "94"]]]]],
              "blank",
             "respec-button",
                ["display-text", function() {return '2D structures'}],
           ["column",[["row",[["buyable", "11"],"blank", ["v-line","200px"],"blank",["buyable", "12"],"blank", ["v-line","200px"],"blank",["buyable", "13"],"blank", ["v-line","200px"],"blank", ["buyable","14"],"blank",["v-line","200px"],"blank",["buyable", "15"]]]]],
             ["display-text", function() {return '3D structures'}],
             ["column",[["row",[["buyable", "21"],"blank", ["v-line","200px"],"blank",["buyable", "22"],"blank", ["v-line","200px"],"blank",["buyable", "23"],"blank", ["v-line","200px"],"blank", ["buyable","24"],"blank",["v-line","200px"],"blank",["buyable", "25"]]]]], 
            ["display-text", function() {return '4D structures'}],
            ["column",[["row",[["buyable", "31"],"blank", ["v-line","200px"],"blank",["buyable", "32"],"blank", ["v-line","200px"],"blank",["buyable", "33"],"blank", ["v-line","200px"],"blank", ["buyable","34"],"blank",["v-line","200px"],"blank",["buyable", "35"]]]]],
          ["display-text", function() {return 'Imperial structures'}],
           ["column",[["row",[["buyable", "41"],"blank", ["v-line","200px"],"blank",["buyable", "42"],"blank", ["v-line","200px"],"blank",["buyable", "43"],"blank", ["v-line","200px"],"blank", ["buyable","44"],"blank",["v-line","200px"],"blank",["buyable", "45"]]]]],
        ],
        
    },
    "Empyrean Island": {
        content: [
               ["display-text", function() {return 'Welcome to Empyrean Island!'},
                {"font-color": "yellow",
                    "font-size": "50px"
                }
               ],
            ...
            "blank",
            ["h-line"],
             ["column",[["row",[["buyable", "95"],"blank","blank", ["buyable", "101"]]]]], 
             ["display-text", function() {return 'Empyrean structures'}],
            ["column",[["row",[["buyable", "51"],"blank", ["v-line","200px"],"blank",["buyable", "52"],"blank", ["v-line","200px"],"blank",["buyable", "53"],"blank", ["v-line","200px"],"blank", ["buyable","54"],"blank",["v-line","200px"],"blank",["buyable", "55"]]]]],
        ]
    },
...
challenges: {
    11: {
        ...
        canComplete: function() {return player.h.points.gte(15)},
        unlocked() {
          ...
          style() {
            ...
            if(this.canComplete()) {
                return {"background-image": "linear-gradient( #f4ff28, #a2aa0d)", ...style}
            }
            else return {...style}
        },
...
upgrades: {
    ...
    buyables: {
       ...
       cost() { return [new Decimal(1200),
        ...
        display() { return "Heafty costs for massive boosts" +
             "   cost:" + format(this.cost()[0]) + " " + " tetras" +
            "   cost:" + format(this.cost()[1]) + " " + " Empryean points"
         },
        unlocked() {
            return (hasChallenge('t', 11))
        },
       
         canAfford() { return player.t.points.gte(this.cost()[0]) && player.t.points6.gte(this.cost()[1]) },
        buy() {
        ...
        style() {
            ...
            if(this.canAfford()) {
                return {"background-image": "linear-gradient(90deg, #090a0e, #08070e)", ...style}
            }
            else return {...style}
        }
       ...
       cost(x) { return new Decimal(2).plus(x) },
        ...
        display() { return "Convert your tetras into 2D points" +
           
            "   cost:" + format(this.cost()) + " " + " tetras"
         },
        unlocked() {
            return true
        },
    ...
    92: {
       cost(x) {return new Decimal(2).plus(x) },
        ...
        display() { return "Convert your 2D tetra points into 3D points" +
           
            "   cost:" + format(this.cost()) + " " + " 2D points"
         },
        unlocked() {
            return true
        },
       
         canAfford() { return player.t.tpoints.gte(this.cost()) },
        buy() {
     ...
     93: {
       cost(x) { return new Decimal(2).plus(x) },
        ...
        display() { return "Convert your 3D tetra points into 4D points" +
           
            "   cost:" + format(this.cost()) + " " + " 3D points"
         },
        unlocked() {
            return true
        },
       
         canAfford() { return player.t.points3.gte(this.cost()) },
        buy() {
      ...
      94: {
       cost(x) { return new Decimal(2).plus(x)
        ...
        display() { return "Convert your 4D tetra points into Imperial points" +
            ...
            "   cost: " + format(this.cost()) + " " + " 4D points    " 
        ...
        unlocked() {
         ...
         canAfford() { return player.t.points4.gte(this.cost())
      ...
      95: {
       cost(x) { return new Decimal(25)
        ...
        display() { return "Convert your Imperial points into Empyrean points" +
           
            "   cost:" + format(this.cost()) + " " + " Imperial points    " 
         ...
         canAfford() { return player.t.points5.gte(this.cost())
    ...
    11: {
        ...
        title: "Tetra Complex",
        display() { return "Each tetra complex boosts multiplier gain by 1.5 compounding   " +
            "currently:" + format(buyableEffect(this.layer,this.id)) + "x        " +
            "   cost:" + format(this.cost()) + " " + " 2D tetra points" +
     ...
     12: {
       cost() { return new Decimal(1) },
        ...
        display() { return "Each tetra penthouse boosts cosmic dust gain by 1.5 compounding   " +
            "currently:" + format(buyableEffect(this.layer,this.id)) + "x        " +
            "   cost:" + format(this.cost()) + " " + " 2D tetra points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
     ...
     13: {
        ...
        display() { return "Each tetra table boosts quark gain by 1.5 compounding   " +
            "currently:" + format(buyableEffect(this.layer,this.id)) + "x        " +
            "   cost:" + format(this.cost()) + " " + " 2D tetra points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
    ...
    14: {
        ...
        display() { return "Each tetra planet boosts vinyl multiplier gain by 1.5 compounding   " +
            "currently:" + format(buyableEffect(this.layer,this.id)) + "x        " +
            "   cost:" + format(this.cost()) + " " + " 2D tetra points. " +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
     ...
     15: {
        ...
        display() { return "Each tetra particle boosts particle gain by 1.5 compounding   " +
            "currently:" + format(buyableEffect(this.layer,this.id)) + "x        " +
            "   cost:" + format(this.cost()) + " " + " 2D tetra points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
     ...
     21: {
        cost() { return new Decimal(1) },
        title: "Tetra City",
        display() { return "Each tetra city increases the limit on hyper quarks(the buyable)  " +
           
            "   cost:" + format(this.cost()) + " " + " 3D tetra points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
        unlocked() {
            return true
     ...
     22: {
       cost() { return new Decimal(1) },
        ...
        display() { return "Each tetra skyscraper lets Heavy Multiplier boost Multiplier   " +
            "currently:" + format(buyableEffect(this.layer,this.id)) + "x        " +
            "   cost:" + format(this.cost()) + " " + " 3D tetra points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
     ...
     23: {
        ...
        display() { return "Each tetra table boosts lets multiplier boost quarks and improves the formula   " +
    ...
    24: {
        ...
        display() { return "Each tetra star boosts cosmic dust(not by a lot)   " +
            "currently:" + format(buyableEffect(this.layer,this.id)) + "x        " +
            "   cost:" + format(this.cost()) + " " + " 3D tetra points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
        ...
        effect() {
            return new Decimal(1).plus(1).plus(getBuyableAmount(this.layer,this.id))
        },
      canAfford() { return player.t.points3.gte(this.cost()) },
        buy() {
            player.t.spent3 = player.t.spent3.plus(this.cost())
     ...
     25: {
        ...
        display() { return "Each tetra quarks boosts multiplier upgrade 13's effect   " +
      ...
      31: {
        ...
        display() { return "Passively generate Vinyl multiplier(max is 50%)  " +
           
            "   cost:" + format(this.cost()) + " " + " 4D tetra points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
        unlocked() {
            return true
     ...
     32: {
        cost() { return new Decimal(1) },
        title: "Tetra Temple",
        display() { return "Passively generate Atoms(max is 10%)  " +
    ...
    33: {
        ...
        display() { return "Passively generate Cosmic Dust(max is 5%)  " +
    ...
    34: {
        ...
        display() { return "Unlock Stars(Buying this again and again passively generates stardust(max .5))  " +
  ...
  35: {
        ...
        display() { return " Bottom quarks now boost particles!   " +
           "currently: " + format(buyableEffect(this.layer,this.id)) + "x   " +
            "   cost:" + format(this.cost()) + " " + " 4D tetra points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
      ...
      41: {
        ...
        display() { return "Boost Vinyl multiplier by Hyper Multiplier(improve formula if you buy more)  " +
             "   currently: " + format(buyableEffect(this.layer, this.id)) + "x" +
            "   cost:" + format(this.cost()) + " " + " Imperial points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
      ...
      42: {
        ...
        display() { return " Add a secondary self-sustaining upgrade and improve its formula!  " +
    ...
    43: {
        ...
        display() { return " Unlock gamma rays under alchemy lab.  " +
    ...
    44: {
        ...
        display() { return " Each Imperial blackhole can devour tetra points in exchange for massive particle boosts  " +
                "   currently: " + format(buyableEffect(this.layer, this.id)) + "x" +
            "   cost:" + format(this.cost()) + " " + " Imperial points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id))
         },
  ...
  45: {
        ...
        display() { return " Raise DNA and RNA limit " +
     ...
     51: {
        ...
        display() { return " Boost Particle gain... By a lot " +
           
            "   cost:" + format(this.cost()) + " " + " Empyrean points. " +
             "   You have:" + format(getBuyableAmount(this.layer, this.id)) +
             "|Effect: " + format(buyableEffect(this.layer, this.id)) + "x, to particle gain"
         },
        unlocked() {
            return hasChallenge('t', 11)
        },
        ...
        canAfford() { return player.t.points6.gte(this.cost()) },
        buy() {
     ...
     52: {
        ...
        display() { return " Passively Generate Tetra " +
     ...
     53: {
        ...
        display() { let [formula1, formula2, formula3] = this.effect()
            return " Gamma Rays, Beta Particles, and Alpha particles boost particle gain. Buy more to improve formula " +
           
            "   cost:" + format(this.cost()) + " " + " Empyrean points" +
             "   You have:" + format(getBuyableAmount(this.layer, this.id)) +
             "|Effects: " + format(formula1) + "x to gamma rays, " + format(formula2) + "x to beta particles, and " + format(formula3) + "x to alpha particles"
         },
        unlocked() {
            return hasChallenge('t', 11)
        },
        effect(x) {
           let formula1 = new Decimal(1).mul(player.ac.gammaray.plus(1).mul(player.ac.gammaray.plus(1).mul(15))).mul(x.plus(1))
           let formula2 = new Decimal(1).mul(player.ac.bparticle.plus(1).pow(1.05)).mul(x.plus(1))
           let formula3 = new Decimal(1).mul((player.ac.aparticle.plus(1).mul(100).mul(player.ac.aparticle.plus(1)))).mul(x.plus(1))
     ...
     54: {
        ...
        display() { return " Cosmic Expansion, new upgrades, subcurrencies, and all in Cosmic Dust, Nissionite, Boracite, and Stargazed Metal " +
     ...
     55: {
        ...
        display() { return " Five times cell boost(every currency in cells)" +
